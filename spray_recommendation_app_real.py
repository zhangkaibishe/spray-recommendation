...
def generate_spray_comparison_data(num_samples=600):
    ...
    for _ in range(num_samples):
        ...
        if material == '棉':
            ...
            base_performance = 70 if spray_type == 'A型喷雾' else 88
        elif material == '尼龙袜':
            base_performance = 65 if spray_type == 'A型喷雾' else 85
        else:  # 防静电服
...
def clean_experiment_data(df):
    ...
    material_mapping = {
        '棉': '棉', '棉质': '棉', '棉质类': '棉',
        '涤纶': '涤纶', '化纤': '涤纶', '化纤类': '涤纶',
        '羊毛袜': '羊毛袜', '羊毛': '羊毛袜', '羊毛类': '羊毛袜',
        '尼龙袜': '尼龙袜', '尼龙': '尼龙袜', '尼龙类': '尼龙袜',
...
class SprayRecommendationSystem:
    def __init__(self, data):
        self.data = data
        self.materials = ['棉', '涤纶', '羊毛袜', '尼龙袜', '防静电服']
        self.model = None
